...
PAGES = [
    ...
    ("docs/network-tests.md", "network-tests.html", "Network Tests",
     "Validate the Marketplace (Slices 1–4) on Local Anvil and Hosted Sepolia, step by step with screenshots."),
    ("docs/token-module.md", "token-module.html", "Slice 1 · Token",
     "Member 1 — EnigCredit ERC-20: mint, faucet, permit/burn; functions, tests, and threat model."),
    ("docs/listings-module.md", "listings-module.html", "Slice 2 · Listings",
     "Member 2 — Marketplace listings: create, browse, cancel; functions, tests, and threat model."),
    ("docs/escrow-module.md", "escrow-module.html", "Slice 3 · Escrow",
     "Member 3 — Marketplace escrow: purchase, confirm, cancel-after-timeout; functions, tests, and threat model."),
    ("docs/reputation-module.md", "reputation-module.html", "Slice 4 · Reputation",
     "Member 4 — Reputation ratings: bidirectional 1–5 scoring after Sold; functions, tests, and threat model."),
